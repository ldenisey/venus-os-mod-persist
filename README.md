...
During installation, *mod-persist* package adds a call to its [boot script](./src/data/etc/mod-persist/boot.sh) in [*/data/rc.local*](https://www.victronenergy.com/live/ccgx:root_access#hooks_to_install_run_own_code_at_boot).
